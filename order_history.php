...
try {
    ...
    $dateColumn = 'order_date'; // default
    if (!in_array('order_date', $columns)) {
        if (in_array('created_at', $columns)) {
            $dateColumn = 'created_at';
        } elseif (in_array('date_ordered', $columns)) {
            $dateColumn = 'date_ordered';
        } else {
            // Use the first date/time column we find
    ...
    $hasDeliveryOption = in_array('delivery_option', $columns);
...
$sql = "SELECT o.id as order_id, u.type, u.color, o.quantity, o.status, o.total_price, o.$dateColumn AS order_date";
if ($hasDeliveryOption) {
    $sql .= ", o.delivery_option";
}
$sql .= " FROM orders o JOIN uniforms u ON o.uniform_id = u.id";
                            ...
                            <table class="min-w-full divide-y divide-gray-200">
                                <thead class="bg-gray-50">
                                    <tr>
                                        ...
                                        <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Uniform Type</th>
